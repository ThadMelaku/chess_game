...
RSpec.describe 'Board' do
  describe Board do
    ...
    context 'Not stalemate' do
      ...
      it 'white is not stalemated' do
        expect(board.stalemate?("white")).to be(false)
      end
      it 'black is not stalemated' do
        expect(board.stalemate?("black")).to be(false)
      end
    end

    context 'In check, stalemate should be false' do
    ...
    context 'Checkmated, stalemate should be false' do
      subject(:board) {Board.new}
      let(:d) {DisplayBoard.new(board)}
